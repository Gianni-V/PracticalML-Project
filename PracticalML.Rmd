...
By example: 
  ...
  * for class B, feature *magnet_dumbbell_y*,
  * for class E, feature *roll_belt*,

give a clear signal with a probability of 80% but actually, it remains quite difficult to extract some explanations on how the outcome is correlated with the features.
